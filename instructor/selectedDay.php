                            ...
                            <div class="tables">
                                <table class="table" border="1" id="attendanceTable">
                                    ...
                                    <tbody>
                                        ...
                                        $datec = $_GET['datec'];
                                        $sql = "SELECT * from attendees_attendance inner join attendees on attendees_attendance.attendeeID = attendees.attendeeID where moduleID= ? and instructorID = ? and datec = ?";
                                        $query = $connection->prepare($sql);
                                        $query->bind_param('sss', $mod_id, $user, $datec);
                                        $query->execute();
                                        ...
                                        if ($results->num_rows > 0) {
                                            while ($row1 = $results->fetch_assoc()) {
                                                ...
                                                <tr class="active">
                                                    ...
                                                    <td><?php echo htmlentities($row1['datec']); ?></td>
