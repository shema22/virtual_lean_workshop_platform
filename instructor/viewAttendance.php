            ...
            <div class="inner-content">
                ...
                <div class="outter-wp">
                    ...
                    <div class="">
                        <?php
$mod_id = $_GET['editid'];                                        
$sql = "SELECT distinct datec FROM attendees_attendance WHERE moduleID = ?";
$query = $connection->prepare($sql);
$query->bind_param('i', $mod_id);
$query->execute();
...
<a href="selectedDay.php?moduleID=<?php echo $mod_id?>&datec=<?php echo htmlentities($row1['datec']);?>">
    <button><?php echo htmlentities($row1['datec']);?></button>
</a>
