                            ...
                            <div class="tables" id="attendanceTable">
                                <table class="table" border="1" id="attendanceTable">
                                    ...
                                    <tbody>
                                        ...
                                        $sid = $_GET['attendeeID'];
                                        $sql = "SELECT * FROM attendees_attendance INNER JOIN attendees ON attendees_attendance.attendeeID = attendees.attendeeID WHERE moduleID= ? AND attendees.attendeeID = ? AND attendees_attendance.instructorID = ?";
                                        $query = $connection->prepare($sql);
                                        $query->bind_param('iii', $mod_id, $sid, $user);
                                        $query->execute();
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            $attendance_percentage = ($count * 100) / $counts;
