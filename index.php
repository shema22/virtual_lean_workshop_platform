...
<head>
    <title>virtual lean workshops platform || Home Page</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-2" id="spy">
                <div class="header-agile">
                    <h1>
                        <a class="navbar-brand" href="index.php">
                           <font color="red">V</font><font color="yellow">L</font>W<font color="blue">P</font>
                        </a>
                    </h1>
                </div>
                ...
                <button type="button" class="btn btn-block mt-lg-5 mt-3 w3ls-btn p-1 btn-theme text-white  text-uppercase font-weight-bold" 
                    >
                    <a class="nav-link" href="instructor/index.php">Instructor</a>
                </button>                
                <button type="button" class="btn btn-block mt-lg-5 mt-3 w3ls-btn p-1 btn-theme text-white  text-uppercase font-weight-bold" 
                    >
                    <a class="nav-link" href="attendees/index.php">Atendees</a>
                    
                </button>
                <button type="button" class="btn btn-block mt-lg-5 mt-3 w3ls-btn p-1 btn-theme text-white  text-uppercase font-weight-bold" 
                    >
                    <a class="nav-link" href="subscription/subscription.php">Subscription</a>
            ...
            <div class="col-lg-10 scrollspy-example pr-0" data-spy="scroll" data-target="#spy">
                ...
                <div id="home" class="w3ls-banner d-flex  align-items-center justify-content-center">
                    ...
                    <div class="bnr-w3pvt text-center">
                        <h4>Welcome to!!</h4>
                        <h2 class="bnr-txt-w3">Virtual Lean Workshop Platform</h2>
                    ...
                    <div class="section">
                        ...
                        <div class="footer-bottom py-lg-5 py-3">
                            ...
                            <div class="footer-copy text-center">
                                <p class="text-dark">Virtual Lean Workshop Platform @ 2024
