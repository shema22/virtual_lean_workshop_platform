...
?>
 <div class="sidebar-menu">
    ...
    <div class="down">  
        ...
        <a href="dashboard.php"><span class=" name-caret"><?php echo $row['userName']; ?></span></a>
    ...
    <div class="menu">
        <ul id="menu" >
            ...
            <li id="menu-academico" ><a href="#"><i class="fa fa-file-text-o"></i><span>Problem Reported</span> <span class="fa fa-angle-right" style="float: right"></span></a>
             ...
             <li id="menu-academico" ><a href="#"><i class="fa fa-file-text-o"></i><span>Subscriptions</span> <span class="fa fa-angle-right" style="float: right"></span></a>
                <ul id="menu-academico-sub" >
                    <li id="menu-academico-boletim" ><a href="viewsubscriber.php">Subscribers Details</a></li>
        </ul>
    </div>
</div>