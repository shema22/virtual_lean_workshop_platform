...
include('includes/dbconnection.php');
    if (isset($_POST['register'])) {
        ...
        $sql2 = "INSERT INTO users (email,userName,password,createdBy) VALUES (?, ?, ?, ?)";
        $stmt2 = $connection->prepare($sql2);
        $stmt2->bind_param("ssss" ,$email,$name,$password,$createdBy);
        $stmt2->execute();
...
<html>
<head>
    <title>virtual lean workshop platform||registration Page</title>
        ...
        <div class="error-top">
            ...
            <div class="login">
                ...
                <div class="buttons login">
                    <h3 class="inner-tittle t-inner" style="color: lightblue">Sign up</h3>
                </div>
                <form id="register" method="post" name="register"> 
                    <input type="text" class="text" placeholder="Enter your E-mail" value="" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'E-mail address';}" name="email" required="true">
