...
if(isset($_POST['login'])) 
{
    ...
    $stmt = $connection->prepare("SELECT attendeeID FROM attendees WHERE email = ? AND password = ?");
    ...
    if ($result->num_rows > 0) {
        ...
        $_SESSION['attendee'] = $row['attendeeID']; 
...
<html>
<head>
    <title>Attendees-Virtual Lean Workshop Platform ||Login Page</title>
...
<body>
    <div class="error_page">
        <div class="error-top">
            <h2 class="inner-tittle page">VLWP Atendees</h2>
            <div class="login">
